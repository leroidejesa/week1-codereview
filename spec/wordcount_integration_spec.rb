...
describe('the wordcount path', {:type => :feature}) do
  it('processes the user entry of a word as well as the user entry of a sentence, and returns the number of occurrances said word makes in said sentence') do
    visit('/')
